...
#
# Script generated by Vivado on Fri Dec 13 22:12:04 +0700 2024
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/multiply.protoinst" -log simulate.log
}
