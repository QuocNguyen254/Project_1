...
#
# Script generated by Vivado on Fri Dec 20 17:01:20 +0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ram_data_fc64_2.sh
...
#
# Usage        : ram_data_fc64_2.sh
#                ram_data_fc64_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_data_fc64_2.sh [-reset_run]
#                ram_data_fc64_2.sh [-reset_log]
#                ram_data_fc64_2.sh [-help]
#
...
# script info
echo -e "ram_data_fc64_2.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_data_fc64_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_data_fc64_2 xil_defaultlib.ram_data_fc64_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_data_fc64_2 -key {Behavioral:sim_1:Functional:ram_data_fc64_2} -tclbatch cmd.tcl -protoinst "protoinst_files/multiply.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram_data_fc64_2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_data_fc64_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_data_fc64_2.sh [-help]\n\
Usage: ram_data_fc64_2.sh [-step]\n\
Usage: ram_data_fc64_2.sh [-lib_map_path]\n\
Usage: ram_data_fc64_2.sh [-reset_run]\n\
Usage: ram_data_fc64_2.sh [-reset_log]\n\
Usage: ram_data_fc64_2.sh [-keep_index]\n\
Usage: ram_data_fc64_2.sh [-noclean_files]\n\n\
