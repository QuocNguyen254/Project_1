...
#
# Script generated by Vivado on Fri Dec 20 17:03:33 +0700 2024
...
simulate()
{
  xsim rom_bias_fc64 -key {Behavioral:sim_1:Functional:rom_bias_fc64} -tclbatch cmd.tcl -protoinst "protoinst_files/multiply.protoinst" -log simulate.log
}
