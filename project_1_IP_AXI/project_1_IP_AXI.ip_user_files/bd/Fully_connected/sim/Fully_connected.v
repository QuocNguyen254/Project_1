...
//Date        : Sun Dec 29 13:02:55 2024
//Host        : DESKTOP-AF4K6S1 running 64-bit major release  (build 9200)
//Command     : generate_target Fully_connected.bd
//Design      : Fully_connected
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Fully_connected,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Fully_connected,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_zynq_ultra_ps_e_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "Fully_connected.hwdef" *) 
module Fully_connected
  ...
  Fully_connected_Fully_Connected_1_0_0 Fully_Connected_1_0
       (.in_data(blk_mem_gen_0_doutb),
        .read_enable(blk_mem_gen_0_doutb[0]),
        ...
        .write_enable(blk_mem_gen_0_doutb[0]));
  Fully_connected_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  Fully_connected_axi_smc_0 axi_smc
  ...
  Fully_connected_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  Fully_connected_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  Fully_connected_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
